...
<html lang="ja">
  <head>
    ...
    <title>
      E-VALUE WORKS | 「早さ・正確さ・親身さ」が揃ったコーディング代行事務所
    </title>
  ...
  <body>
        ...
        <nav class="l-header__nav">
          <ul class="p-gnav">
            <li class="p-gnav__item p-gnav__item--home">
              <a href="price.html#coding-plan">ホーム</a>
            </li>
    ...
    <main class="l-content">
      <section class="p-top-mainVisual">
        ...
        <div class="p-top-mainVisual__inner l-container">
          ...
          <div class="p-top-mainVisual__buttons">
            <a
              href="#contact"
              class="p-top-mainVisual__button p-top-mainVisual__button--contact"
              >fお見積り・ご相談</a
            >
            <a
              ...
              target="_blank"
              ><img src="dist/img/cw_logomark_color.svg" />Chatworkでご相談</a
            >
          </div>
        </div>
      </section>
          ...
          <div class="l-container">
            ...
            <div class="p-top-troubles__circle">
              ...
              <div class="p-top-troubles__center">
                <img src="dist/img/overthinking-man.png" alt="" />
              </div>
            </div>
          </div>
        </div>
              ...
              <dd class="p-top-about__itemDetail">
                ...
                <div class="c-snslinks p-top-about__sns">
                  <a
                    ...
                    target="_blank"
                    class="c-snslinks__link c-snslinks__instagram"
                    ><i class="fa-brands fa-instagram"></i
                  ></a>
                  <a
                    href="https://www.facebook.com/ryouslash/"
                    target="_blank"
                    class="c-snslinks__link c-snslinks__facebook"
                    ><i class="fa-brands fa-facebook"></i
                  ></a>
                  <a
                    href="https://github.com/ryouslash/"
                    target="_blank"
                    class="c-snslinks__link c-snslinks__github"
                    ><i class="fa-brands fa-github"></i
                  ></a>
                  <a
                    href="https://www.linkedin.com/in/ryo-ikeda-48861a140/"
                    target="_blank"
                    class="c-snslinks__link c-snslinks__linkedin"
                    ><i class="fa-brands fa-linkedin"></i
                  ></a>
                  <a
                    href="http://plusoneweb.net/"
                    target="_blank"
                    class="c-snslinks__link c-snslinks__blog"
          ...
          <div class="p-top-work__inner">
            ...
            <div class="p-top-work__slider">
              ...
              <div class="p-top-work__slider-item">
                <a href="#">
                  <figure class="p-top-work__photo">
                    <img src="dist/img/work4.png" />
                  </figure>
                  <div class="p-archive-work__industry">宿泊施設</div>
                  <h3 class="p-top-work__title">
                    <span class="u-inline-block">大阪野田の</span
                    ><span class="u-inline-block"
                      >サウナ付きデザイナーズホテル</span
                    >
        ...
        <div class="l-container">
          <div class="p-top-promise__inner">
            <div class="p-top-promise__fixed">
                ...
                <dl class="p-top-promise__item">
                  <dt class="p-top-promise__title">
                    ...
                    <div>
                      <span class="u-inline-block"
                        >迅速な対応でリモートの不便を</span
                      ><span class="u-inline-block">感じさせません</span>
                    </div>
                  </dt>
                  <dd class="p-top-promise__detail">
                    <p>
              ...
              <!-- <img src="dist/img/partner.png" alt=""> -->
            </div>
            <div class="p-top-promise__scroll">
              <div class="p-top-promise__img">
                <figure>
                  <img src="dist/img/promise1.png" alt="" />
                  <figcaption>
              ...
              <div class="p-top-promise__img">
                <figure>
                  <img src="dist/img/promise2.png" alt="" />
                  <figcaption>
                    <div class="p-top-promise__title">
                      <span>お約束2</span>
              ...
              <div class="p-top-promise__img">
                <figure>
                  <img src="dist/img/promise3.png" alt="" />
                  <figcaption>
                    <div class="p-top-promise__title">
                      <span>お約束3</span>
                      <div>思いやりの気持ちを大切にします</div>
              ...
              <div class="p-top-promise__img u-mb0">
                <figure>
                  <img src="dist/img/promise4.png" alt="" />
                  <figcaption>
                    <div class="p-top-promise__title">
                      <span>お約束4</span>
                      <div>継続的に自己研鑽に努めます</div>
          ...
          <div class="p-top-price__plans">
            <div class="p-top-price__plan p-top-price__plan--coding">
              <div class="p-top-price__planUpper">
                ...
                <p class="p-top-price__firstText u-text--center">
                  <span class="u-inline-block">高品質なコーデイングを</span
                  ><span class="u-inline-block">プロジェクト単位で</span
                  ><span class="u-inline-block">依頼したい方向け</span>
                </p>
            ...
            <div class="p-top-price__plan p-top-price__plan--maintenance">
              <div class="p-top-price__planUpper">
                ...
                <p class="p-top-price__firstText u-text--center">
                  <span class="u-inline-block">細かな運用・保守業務を</span
                  ><span class="u-inline-block"
                    >月額契約で外注したい方向け</span
                  >
                </p>
        ...
        <div class="l-container">
          ...
          <div class="p-top-faq__inner">
            <div class="p-top-faq__left">
              <img src="dist/img/man-with-green-tie.png" />
            </div>
              ...
              <dl class="p-top-faq__list p-top-faq__list1 is-open">
                ...
                <dd class="p-top-faq__answer">
                  <p>
                    ...
                    <span class="u-inline-block">Safari（iOS）</span
                    >の最新バージョンの表示確認をします。<br />Internet
                    Explorerに関しては日本国内における<a
                      href="https://gs.statcounter.com/browser-market-share/all/japan/#monthly-202307-202407"
                      >最新のブラウザシェア</a
                    >において0.1-0.4%程度のためサポート致しません。
                  </p>
                </dd>
              </dl>
      ...
      <section class="p-top-contact" id="contact">
        <h2 class="c-title1">
          <span class="u-inline-block">無料相談・お問い合わせは</span
          ><span class="u-inline-block">こちら</span>
        </h2>
          ...
          <div class="l-slim-container">
            <form class="p-contactForm">
              ...
              <div class="p-contactForm__item">
                ...
                <textarea
                  placeholder="プロジェクトの概要や予算、納期希望、特記事項等を詳しくお書き下さい。"
                ></textarea>
              </div>
