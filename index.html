                  ...
                  <a href="#">
                    ...
                    <div class="p-postList__right">
                      ...
                      <div class="p-postList__metas">
                        <time class="p-postList__time">2024.08.13</time>
                        <div class="p-postList__taxonomy">Web制作</div>
                      </div>
                      <div class="p-postList__excerpt">
                        ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入りま・・・
                      </div>
                    </div>
                  </a>
                </li>
