...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  initTypingAnimation().then(function () {
...
function initTypingAnimation() {
  ...
  return new Promise(function (resolve) {
    // 1秒待ってからスタート
    setTimeout(function () {
      var typing = function typing(el, sentence, delay) {
      ...
      if (lang === "en-US") {
        typing(".js-typing--en", "Fast Response & Careful Finish!\nReliable Coding You Can Trust", 60);
      } else {
        typing(".js-typing--ja", "迅速対応・丁寧仕上げ！\n安心して任せられるコーディング代行", 100);
      }
    }, 1000);
  });
}
